            ...
            <div class="row">
                    ...
                    <a  href="{{url('/category')}}" class="card col-md-4 " style="border:none;">
                        <div class="card-body zoom postion-relative">
                            <img src="{{asset('images/simple.jpg')}}"  class="w-100 lazy rounded" height="200px"   alt="">
                            <div class="text-light position-absolute top-50 start-50 translate-middle">
                                <h4 style="letter-spacing:3px; ">Simple</h4>
                            </div>
                        </div>
                    </a>
                    <a href="{{url('/category')}}"   class="card col-md-4 " style="border:none;">
                        <div class="card-body zoom postion-relative">
                            <img src="{{asset('images/premium.jpg')}}"  class="w-100 lazy rounded" height="200px"  alt="">
                            <div class="text-light position-absolute top-50 start-50 translate-middle">
                                <h4 style="letter-spacing:3px; ">Premium</h4>
                            </div>
                        </div>
                    </a>
                    <a href="{{url('/category')}}" class="card col-md-4 " style="border:none;">
                        <div class="card-body zoom postion-relative">
                            <img src="{{asset('images/deluxe.jpg')}}"  class="w-100 lazy rounded" height="200px"  alt="">
                            <div class="text-light position-absolute top-50 start-50 translate-middle">
                                <h4 style="letter-spacing:3px; ">Deluxe</h4>
                            </div>
                        </div>
                    </a>
