            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h2 class="mb-0">
                            {{ $product->name }}
                            <label for="" style="font-size: 1rem; background:rgba(234,88,11,255); color:white;"
                                class="float-end badge  trending_tag">{{ $product->trending == '1' ? 'Trending' : '' }}</label>
                        </h2>
                        <hr>
                        <label for="" class="me-3">Original Price : <s>Tk
                                {{ $product->original_price }}</s></label>
                        <label for="" class="fw-bold">Selling Price : Tk{{ $product->selling_price }}</label>
                        <p class="mt-3">
                            {!! $product->small_description !!}
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam labore quibusdam voluptate
                            repudiandae accusamus dicta aut voluptates doloremque perspiciatis beatae!
                        ...
                        <div class="row mt-2">
                            <div class="col-md-10">
                                <br />
                                <button class="btn btn-outline-primary me-3 float-start addToCartButton" onclick="window.location='{{route('add_to_cart', $product->id)}}'">Add to Cart <i
